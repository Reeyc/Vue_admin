    ...
    getData() {
      this.$http.home
        ...
        .then(res => {
          ...
          this.oneSceneD = res.data.d;
          this.oneSceneY = res.data.m;
          this.oneSceneOY = res.data.y;
          this.echartsData = this.oneSceneD;
        ...
        toolbox: {
          ...
          feature: {
            ...
            myTool2: {
              ...
              onclick: () => {
                this.echartsData = this.oneSceneY;
                this.echartsTitle = "一类场景 / 1年";
              }
            },
            myTool3: {
              title: "历年统计",
              ...
              onclick: () => {
                this.echartsData = this.oneSceneOY;
                this.echartsTitle = "一类场景 / 历年";
              }
            }
          }
        },
