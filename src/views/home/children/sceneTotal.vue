...
export default {
  data: () => ({
    chartsType: "sceneTotal",
    echartsData: null,
    sceneTotalD: null,
    sceneTotalM: null,
    sceneTotalY: null,
    echartsTitle: "场景汇总 / 7日"
  }),
    ...
    getData() {
      this.$http.home
        ...
        .then(res => {
          ...
          this.sceneTotalD = this.result.d;
          this.sceneTotalM = this.result.m;
          this.sceneTotalY = this.result.y;
          this.echartsData = this.sceneTotalD;
        ...
        toolbox: {
          ...
          feature: {
            ...
            myTool2: {
              ...
              onclick: () => {
                this.echartsData = this.sceneTotalM;
                this.echartsTitle = "场景汇总 / 30日";
              }
            },
            myTool3: {
              title: "今年统计",
              ...
              onclick: () => {
                this.echartsData = this.sceneTotalY;
                this.echartsTitle = "场景汇总 / 1年";
              }
            }
          }
        },
